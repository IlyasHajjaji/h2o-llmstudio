...
def read_dataframe(
    ...
    if path.endswith(".csv"):
        ...
        # print("Initial DataFrame Shape:", df.shape)  # Debug line
    ...
    if fill_columns:
        ...
        print("Columns in DataFrame:", df.columns.tolist())  # Debug line
    ...
    print("non_missing_columns", len(non_missing_columns))

    if len(non_missing_columns):
        print("Okkk ICIIIIIII")
    ...
    df_filtered = df.dropna(subset=['challenge', 'reference']).reset_index(drop=True)

    # # Create a new column named 'group' and assign values based on the task type
    # df_filtered['group'] = df_filtered['task'].apply(lambda x: 'summarization' if x == 'summarization' 
    #                                                 else 'inference' if x == 'inference' 
    #                                                 else 'progra' if x == 'organic_synth'
    #                                                 else 'others'
    #                                                 )
